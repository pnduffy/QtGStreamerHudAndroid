...
Rectangle {
    ...
    function activeUasSet() {
		...
		informationIndicator.watts = Qt.binding(function() { return currentState.watts})
		
		informationIndicator.gpshdop = Qt.binding(function() { return currentState.gpsddop})
		informationIndicator.satcount = Qt.binding(function() { return currentState.satcount})
		...
		informationIndicator.lat = Qt.binding(function() { return currentState.lat})
		informationIndicator.lng = Qt.binding(function() { return currentState.lng})
